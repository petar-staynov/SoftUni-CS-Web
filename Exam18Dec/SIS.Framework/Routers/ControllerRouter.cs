...
//            string actionName = controllerAndActionNames[1];
            ...
            //Fixed lowercase controller and views to work
            string controllerName =
                char.ToUpper(controllerAndActionNames[0][0]) + controllerAndActionNames[0].Substring(1);
            string actionName =
                char.ToUpper(controllerAndActionNames[1][0]) + controllerAndActionNames[1].Substring(1);
